...
class ArticleController extends BaseController
{
    ...
    protected function grid(){
        return Grid::make(new Article(), function (Grid $grid) {
            ...
            $grid->column('title');
            $this->sys['article']['image_show'] ? $grid->column('image')->image('', 40, 40) : '';
            if($this->sys['article']['tag_show']){
            ...
            $this->sys['article']['author_show'] ? $grid->column('author') : '';
            $this->sys['article']['intro_show'] ? $grid->column('intro')->limit(30, '...') : '';
            $this->sys['article']['keyword_show'] ? $grid->column('keyword')->limit(30, '...') : '';
    ...
    protected function form()
    {
        return Form::make(new Article(), function (Form $form) {
            ...
            $this->sys['article']['image_show'] ? $form->image('image')->autoUpload() : '';
